  ...
  return (
    <div className="">
      ...
      <div className="bg-slate-900 w-full h-screen ">
        ...
        <div className="text-white grid grid-cols-1 lg:grid-cols-2 mx-24 lg:my-20 ">
          <h1 className="text-xl lg:text-5xl font-light capitalize text-left w-full lg:w-1/2">
            our programs that prompt running
          </h1>
          <div className="flex flex-col justify-between">
            <p className="text-left font-serif tracking-wide leading-6 capitalize text-base mb-5">
